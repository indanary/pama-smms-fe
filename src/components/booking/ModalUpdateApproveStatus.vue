    ...
    <q-card style="width: 1000px">
      <q-card-section>
        <div style="display: flex; justify-content: space-between; align-items: center">
          <span style="font-size: 18px; font-weight: 500">Modal Approve Booking Status </span>
          <q-btn icon="close" size="sm" dense @click="onDialogCancel"></q-btn>
        </div>
      </q-card-section>

      <q-card-section>
        <span>Are you sure want to approve this booking?</span>
      </q-card-section>
      ...
      <q-card-section>
        <div style="display: flex; justify-content: end; align-items: center; gap: 8px">
          ...
          <q-btn no-caps label="Approve" color="primary" @click="onUpdate"></q-btn>
        </div>
      </q-card-section>
    </q-card>
  </q-dialog>
